...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/flex/p1.py")
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/flex/p2.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/flex/p3.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/flex/p4.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/flex/p5.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/flex/p6.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
