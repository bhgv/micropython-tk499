...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/grid/p1.py")
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/grid/p2.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/grid/p3.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/grid/p4.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/grid/p5.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
...
def foo(e):
    if e.get_code() ==  lv.EVENT.CLICKED:
        lv_utils.ex_new_page("exams/layouts_ex/grid/p6.py")
btn.add_event_cb(foo, lv.EVENT.ALL, None)
label = lv.label(btn)
